!function (n) {
    ...
    "use strict";
    function e(i, t) {
        this.element = i, this.options = n.extend({}, r, t), this._defaults = r, this.ns = "." + s + o++, this._name = s, this.init()
    }

    var s = "countrySelect", o = 1, r = {
        defaultCountry: "",
    ...
    n(i).on("load", function () {
        ...
        init: function () {
            ...
            var t = n("<div>", {class: "flag-dropdown"}).insertAfter(this.countryInput), a = n("<div>", {class: "selected-flag"}).appendTo(t);
            ...
            var t = this.countryInput.offset().top, a = n(i).scrollTop(), e = t + this.countryInput.outerHeight() + this.dropdownHeight < a + n(i).height(), s = t - this.dropdownHeight > a, o = !e && s ? "-" + (this.dropdownHeight - 1) + "px" : "";
            ...
            if (n && n.offset()) {
                var i = this.countryList, t = i.height(), a = i.offset().top, e = a + t, s = n.outerHeight(), o = n.offset().top, r = o + s, u = o - a + i.scrollTop();
                if (o < a)i.scrollTop(u); else if (r > e) {
                    var l = t - s;
                    i.scrollTop(u - l)
                }
            }
        ...
        if ("string" == typeof i && "_" !== i[0] && "init" !== i) {
            ...
            return this.each(function () {
                ...
                a instanceof e && "function" == typeof a[i] && (o = a[i].apply(a, Array.prototype.slice.call(t, 1))), "destroy" === i && n.data(this, "plugin_" + s, null)
            }), o !== a ? o : this
        }
